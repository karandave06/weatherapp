...
const Weathercard = ({
  ...
  console.log(place, "place is this")
  ...
  return (
    <div className="w-[22rem] min-w-[22rem] min-h-[30rem] glassCard p-4">
      <div className="w-full flex justify-center items-center gap-4 mt-12 mb-4">
